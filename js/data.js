...
const CHANGELOG = [
  {
    ...
    d: "2026-09-20",
    notes: [
      "ガチャ演出を大幅強化。レア度が高いほどチャージ演出→画面フラッシュ→画面揺れ→紙吹雪の量が跳ね上がる。",
      "URはレインボーオーラ、LRは3連フラッシュ+3連紙吹雪+専用ファンファーレの超演出に。",
      "全ての合成効果音をWeb Audioで追加(アセット無し)。",
      "演出中はいつでも「▶▶ スキップ」で即結果表示。新設の設定タブから演出/効果音のON・OFF、常時スキップも選べる。",
      "設定タブを新設、データリセットを記録タブから移動。",
    ],
  },
  {
    v: "1.1.0",
